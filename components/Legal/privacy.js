...
const Privacy = () => (
  <LegalStyles>
    <InnerDiv>
      ...
      <p>Effective date: March 25, 2019</p>

      <p>
        Allicin Static Demo ("us", "we", or "our") operates the
        https://allicin.io/ website (the "Service").
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for Allicin Static
        Demo is created with the help of the{' '}
      ...
      <p>
        ...
        our Terms and Conditions, accessible from https://allicin-static.now.sh/
      </p>
      ...
      <p>Allicin Static Demo uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Allicin Static Demo will take all steps reasonably necessary to ensure
      ...
      <p>
        Allicin Static Demo may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of Allicin Static Demo
        </li>
        <li>
