  ...
  <LegalStyles>
    <InnerDiv>
      ...
      <p>
        ...
        of Allicin Static Demo's Website.
      </p>{' '}
      <br />
      <span> Allicin Static Demo</span> is located at: https://allicin.io
      <br />
      <address>
        <br />
      </address>
      <p>
        ...
        conditions in full. Do not continue to use Allicin Static Demo's website
      ...
      <p>
        ...
        prevailing law of Massachusetts. Any use of the above terminology or
      ...
      <h3>License</h3>
      <p>
        Unless otherwise stated, Allicin Static Demo and/or it’s licensors own
        the intellectual property rights for all material on Allicin Static
        Demo. All intellectual property rights are reserved. You may view and/or
        print pages from https://allicin-static.now.sh/ for your own personal
        use subject to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://allicin-static.now.sh/</li>
        <li>
          Sell, rent or sub-license material from https://allicin-static.now.sh/
        </li>
        <li>
          Reproduce, duplicate or copy material from
          https://allicin-static.now.sh/
        </li>
      </ol>
      <p>
      ...
      <p>
        ...
        Allicin Static and (d) where the link is in the context of general
      ...
      <p>
        ...
        e-mail to{' '}
        <a
          href="mailto:jayfallon@gmail.com"
          title="send an email to jayfallon@gmail.com"
        >
          jayfallon@gmail.com
        </a>
      ...
      <p>
        No use of Allicin Static Demo’s logo or other artwork will be allowed
